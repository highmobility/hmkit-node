...
var _CapabilitiesCommand = require('src/Commands/CapabilitiesCommand');

var _CapabilitiesCommand2 = _interopRequireDefault(_CapabilitiesCommand);

var _DiagnosticsCommand = require('src/Commands/DiagnosticsCommand');

var _DiagnosticsCommand2 = _interopRequireDefault(_DiagnosticsCommand);

var _EngineCommand = require('src/Commands/EngineCommand');

var _EngineCommand2 = _interopRequireDefault(_EngineCommand);

var _VehicleLocationCommand = require('src/Commands/VehicleLocationCommand');

var _VehicleLocationCommand2 = _interopRequireDefault(_VehicleLocationCommand);

var _VehicleStatusCommand = require('src/Commands/VehicleStatusCommand');
