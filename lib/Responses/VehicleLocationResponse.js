...
var _encoding = require('src/encoding');
...
var VehicleLocationResponse = function () {
  ...
  _createClass(VehicleLocationResponse, [{
    ...
    value: function getLatitude(bytes) {
      return (0, _encoding.ieee754ToBase10)([bytes[3], bytes[4], bytes[5], bytes[6]]);
    }
  }, {
    key: 'getLongitude',
    value: function getLongitude(bytes) {
      return (0, _encoding.ieee754ToBase10)([bytes[7], bytes[8], bytes[9], bytes[10]]);
    }
  }]);
