  ...
  _createClass(SdkNodeBindings, [{
    ...
    value: function setup() {
      ...
      this.onGetSerialNumber(function () {
        return (0, _encoding.hexToUint8Array)(_this2.hmkit.clientCertificate.getSerial()).buffer;
      });
      this.onGetLocalPublicKey(function () {
        return (0, _encoding.hexToUint8Array)(_this2.hmkit.clientCertificate.get().publicKey).buffer;
      });
      this.onGetLocalPrivateKey(function () {
        return (0, _encoding.base64ToUint8)(_this2.hmkit.clientPrivateKey).buffer;
      });
      this.onGetDeviceCertificate(function () {
        return (0, _encoding.base64ToUint8)(_this2.hmkit.clientCertificate).buffer;
      });
